...
HIGH_SHORT_FLOAT_STOCKS  = {
    ...
    "DTCX", "DUST", "DVLT", "DWSN", "DXST", "DXYZ",
    "EAF", "EDSA", "ELVN", "ERAS", "ETHD", "ETHT",
    "EUDA", "EVH", "EVMN", "EVTV", "EWTX", "EYE",
    "FATN", "FBIO", "FBYD", "FCHL", "FEED", "FFAI",
    "FGL", "FLNC", "FOSL", "FOUR", "GDXD", "GDXU",
    "GLSI", "GLUE", "GLWG", "GOGO", "GRND", "HCTI",
    "HNRG", "HPK", "HRTX", "HTCO", "HTZ", "HUMA",
    "HUT", "HYPD", "IBRX", "IBTA", "ICU", "IDYA",
    "INDI", "INDO", "IONZ", "IRE", "IREG", "ISSC",
    "JBLU", "JDZG", "JNUG", "KALV", "KIDZ", "KLRS",
    "KOD", "KORU", "KPTI", "KRRO", "KULR", "KVYO",
    "LASE", "LCID", "LE", "LENZ", "LICN", "LMRI",
    "LOVE", "LUD", "LUNR", "LVWR", "MARA", "MDGL",
    "MED", "METU", "MGTX", "MKDW", "MKT", "MLKN",
    "MRAL", "MRLN", "MRNO", "MULL", "MUU", "MUX",
    "MVIS", "NAMM", "NAUT", "NAVN", "NBIG", "NBIS",
    "NCI", "NDRA", "NEXT", "NFE", "NGNE", "NOAH",
    "NOTE", "NSRX", "NTLA", "NUGT", "NVTS", "OGEN",
    "OKLO", "OKLS", "OKUR", "OLPX", "ONDG", "ONDS",
    "ORGN", "ORGO", "ORIC", "OXM", "PALI", "PGEN",
    "PLCE", "PONY", "PROF", "PROP", "QBTZ", "QNCX",
    "QNRX", "QNTM", "QVCGA", "RBNE", "RCAT", "RCAX",
    "RDTL", "REED", "RENX", "RETO", "RIME", "RIOX",
    "RKLX", "RKLZ", "RNAC", "ROMA", "RVI", "RXT",
    "RZLT", "SATS", "SCVL", "SER", "SHMD", "SHNY",
    "SION", "SKIL", "SKIN", "SKLZ", "SLNH", "SLON",
    "SMCX", "SMCZ", "SMX", "SNBR", "SND", "SNSE",
    "SOC", "SOLT", "SOWG", "SOXS", "SPIR", "SPRY",
    "SRPT", "SUNE", "SWMR", "TASK", "TBCH", "TEAD",
    "TECX", "TERN", "TNGX", "TPET", "TRIP", "TRON",
    "TSSI", "TTEC", "TURB", "UAMY", "UGRO", "UPXI",
    "UUUG", "VCIC", "VCX", "VIVO", "VNET", "VRCA",
    "VSTM", "VTIX", "WATT", "WKHS", "WOLF", "WS",
    "WTI", "WULF", "WVE", "WYFI", "XRX", "XYF",
    "YANG", "YDDL", "YINN", "ZSL",
}
