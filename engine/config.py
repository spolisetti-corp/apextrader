...
HIGH_SHORT_FLOAT_STOCKS  = {
    ...
    "IDYA", "IMAX", "IMTE", "INDI", "INDO", "IONZ",
    "IRE", "IREG", "ISSC", "JBLU", "JDZG", "JNUG",
    "KALV", "KIDZ", "KLRS", "KOD", "KORU", "KPTI",
    "KRRO", "KULR", "KVYO", "LASE", "LCID", "LE",
    "LENZ", "LICN", "LMRI", "LOVE", "LUD", "LUNR",
    "LVWR", "MARA", "MDGL", "MED", "METU", "MGTX",
    "MKDW", "MKT", "MLKN", "MRAL", "MRLN", "MRNO",
    "MULL", "MUU", "MUX", "MVIS", "NAMM", "NAUT",
    "NAVN", "NBIG", "NBIS", "NCI", "NDRA", "NEXT",
    "NFE", "NGNE", "NOAH", "NOTE", "NSRX", "NTLA",
    "NUGT", "NVTS", "OGEN", "OKLO", "OKLS", "OKUR",
    "OLPX", "ONDG", "ONDS", "ORGN", "ORGO", "ORIC",
    "OXM", "PALI", "PGEN", "PLCE", "PONY", "PROF",
    "PROP", "QBTZ", "QNCX", "QNRX", "QNTM", "QVCGA",
    "RBNE", "RCAT", "RCAX", "RDTL", "REED", "RENX",
    "RETO", "RIME", "RIOX", "RKLX", "RKLZ", "RNAC",
    "ROMA", "RVI", "RXT", "RZLT", "SATS", "SCVL",
    "SER", "SHMD", "SHNY", "SION", "SKIL", "SKIN",
    "SKLZ", "SLNH", "SLON", "SMCX", "SMCZ", "SMX",
