...
HIGH_SHORT_FLOAT_STOCKS  = {
    ...
    "BTU", "BZUN", "CAR", "CBIO", "CBUS", "CDIO",
    "CELC", "CGEM", "CGON", "CHAC", "CHPT", "CHRS",
    "CIFG", "CIFR", "CISS", "CNVS", "CNXC", "CONL",
    "CORZ", "CRCA", "CRCG", "CRDF", "CRK", "CRVS",
    "CRWD", "CRWG", "CRWL", "CVI", "CVV", "CYN",
    "DAMD", "DBI", "DERM", "DJI", "DNA", "DNTH",
    "DNUT", "DOCN", "DRVN", "DTCX", "DUST", "DVLT",
    "DWSN", "DXST", "DXYZ", "EAF", "EBS", "EDSA",
    "EEIQ", "ELVN", "ERAS", "ETHD", "ETHT", "ETR",
    "EUDA", "EVH", "EVMN", "EVTV", "EWTX", "EYE",
    "FATN", "FBGL", "FBIO", "FBYD", "FCHL", "FEED",
    ...
    "LE", "LENZ", "LEU", "LGN", "LGVN", "LICN",
    "LMRI", "LOVE", "LUD", "LUNR", "LVWR", "MARA",
    "MDCX", "MDGL", "MED", "METU", "MGTX", "MKDW",
    "MKT", "MLKN", "MNTS", "MRAL", "MRLN", "MRNO",
    "MSS", "MSTX", "MULL", "MUU", "MUX", "MVIS",
    "MVO", "NAMM", "NAUT", "NAVN", "NBIG", "NBIL",
    "NBIS", "NCI", "NDRA", "NEXT", "NFE", "NGNE",
    "NMAX", "NOAH", "NOTE", "NSRX", "NTLA", "NUGT",
    "NVTS", "OGEN", "OKLL", "OKLO", "OKLS", "OKTA",
    "OKUR", "OLPX", "ONCO", "ONDG", "ONDS", "ORGN",
    "ORGO", "ORIC", "ORIS", "OXM", "PALI", "PANW",
    "PCRX", "PGEN", "PGY", "PHGE", "PLCE", "PLTZ",
    "POLA", "PONY", "PROF", "PROP", "QBTZ", "QNCX",
    "QNRX", "QNTM", "QVCGA", "RBNE", "RCAT", "RCAX",
    "RCKT", "RDTL", "REED", "RENX", "REPL", "RETO",
    "RILY", "RIME", "RIOX", "RKLX", "RKLZ", "RLYB",
    "RNAC", "ROMA", "RR", "RVI", "RXT", "RZLT",
    "SAIL", "SATS", "SBIT", "SCVL", "SER", "SGML",
    "SHMD", "SHNY", "SIGA", "SION", "SKIL", "SKIN",
    "SKLZ", "SLNH", "SLON", "SMCX", "SMCZ", "SMST",
    "SMX", "SNBR", "SND", "SNSE", "SOC", "SOLT",
    "SOWG", "SOXS", "SPCE", "SPIR", "SPRC", "SPRY",
    "SRPT", "SUNE", "SWMR", "TASK", "TBCH", "TDUP",
    "TEAD", "TECX", "TERN", "TNGX", "TPET", "TRIP",
    "TRON", "TSSI", "TTEC", "TURB", "TWST", "UAMY",
    "UGRO", "UNG", "UPXI", "UUUG", "VCIC", "VCX",
    "VERI", "VIVO", "VNET", "VOR", "VRCA", "VSTM",
    "VTIX", "VTS", "WATT", "WKHS", "WOLF", "WRAP",
    "WS", "WTI", "WULF", "WVE", "WYFI", "XRX",
    "XTIA", "XYF", "YANG", "YDDL", "YINN", "ZBIO",
    "ZS", "ZSL",
}
