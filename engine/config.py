...
HIGH_SHORT_FLOAT_STOCKS  = {
    ...
    "AIFF", "AIRS", "ALBT", "AMPG", "ANAB", "ANNA",
    "ANNX", "APGE", "APLD", "APP", "APPX", "ARCT",
    "ARTL", "ARWR", "ASPI", "ASST", "ASTI", "ASTS",
    "ATAI", "ATPC", "AVTX", "AVXL", "AXTI", "AZ",
    "BABX", "BAK", "BATL", "BBNX", "BBW", "BCRX",
    "BEAM", "BETR", "BF", "BFLY", "BHVN", "BIAF",
    "BIRD", "BITU", "BKSY", "BLSH", "BMEA", "BMNZ",
    "BNAI", "BNRG", "BOIL", "BOXL", "BTBD", "BTBT",
    "BTDR", "BTU", "BZUN", "CAR", "CBIO", "CBUS",
    "CDIO", "CELC", "CGEM", "CGON", "CHAC", "CHPT",
    "CHRS", "CIFG", "CIFR", "CISS", "CNVS", "CNXC",
    "CONL", "CORZ", "CRCA", "CRCG", "CRDF", "CRK",
    "CRVS", "CRWD", "CRWG", "CRWL", "CVI", "CVV",
    "CYN", "DAMD", "DBI", "DERM", "DJI", "DNA",
    "DNTH", "DNUT", "DOCN", "DRVN", "DTCX", "DUST",
    "DVLT", "DWSN", "DXST", "DXYZ", "EAF", "EBS",
    "EDSA", "EEIQ", "ELVN", "ERAS", "ETHD", "ETHT",
    "ETR", "EUDA", "EVH", "EVMN", "EVTV", "EWTX",
    "EYE", "FATN", "FBGL", "FBIO", "FBYD", "FCHL",
    "FEED", "FFAI", "FGL", "FLNC", "FOSL", "FOUR",
    "FROG", "GDXD", "GDXU", "GEF", "GLND", "GLSI",
    "GLUE", "GLWG", "GNPX", "GOGO", "GRND", "GRPN",
    "HCTI", "HNRG", "HOOG", "HPK", "HRTX", "HTCO",
    "HTZ", "HUBC", "HUMA", "HUT", "HYPD", "IBRX",
    "IBTA", "ICU", "IDYA", "IEP", "IMAX", "IMTE",
    "INDI", "INDO", "IONZ", "IRE", "IREG", "ISSC",
    "IXHL", "JBLU", "JDZG", "JNUG", "KALV", "KIDZ",
    "KLRS", "KOD", "KOLD", "KORU", "KPTI", "KRRO",
    "KRUS", "KULR", "KVYO", "LAR", "LASE", "LBGJ",
    "LCID", "LE", "LENZ", "LEU", "LGN", "LGVN",
    "LICN", "LMND", "LMRI", "LOVE", "LUD", "LUNR",
    "LVWR", "MARA", "MDCX", "MDGL", "MED", "METU",
    "MGTX", "MKDW", "MKT", "MLKN", "MNTS", "MRAL",
    "MRLN", "MRNO", "MSS", "MSTX", "MULL", "MUU",
    ...
    "REPL", "RETO", "RGTZ", "RILY", "RIME", "RIOX",
    "RKLX", "RKLZ", "RLYB", "RNAC", "ROMA", "RR",
    "RVI", "RXT", "RZLT", "SAIL", "SATS", "SBIT",
    "SCVL", "SER", "SGML", "SHMD", "SHNY", "SIGA",
    "SION", "SKIL", "SKIN", "SKLZ", "SLNH", "SLON",
    "SMCX", "SMCZ", "SMST", "SMX", "SNBR", "SND",
    "SNSE", "SOC", "SOLT", "SOWG", "SOXS", "SPCE",
    "SPIR", "SPRC", "SPRY", "SRPT", "SUNE", "SWMR",
    "TASK", "TBCH", "TDUP", "TEAD", "TECX", "TERN",
    "TNGX", "TPET", "TRIP", "TRON", "TSSI", "TTEC",
    "TURB", "TWST", "UAMY", "UGRO", "UNG", "UPXI",
    "UUUG", "UWMC", "VCIC", "VCX", "VERI", "VIVO",
    "VNET", "VOR", "VRCA", "VSTM", "VTIX", "VTS",
    "WATT", "WKHS", "WOLF", "WRAP", "WS", "WT",
    "WTI", "WULF", "WVE", "WYFI", "XRX", "XTIA",
    "XYF", "YANG", "YDDL", "YINN", "ZBIO", "ZS",
    "ZSL",
}
